...
from src.utils import call_gemini_llm, call_oai_rm_llm
            ...
            for ground_truth in processed_ground_truths:
                try:
                    ...
                    if "[[YES]]" in orm_response:
                        return RewardOutput(
                            reward=self.config.correct_reward, is_correct=True
                        )
...
def r1_reward_fn(
    solution_str: str, ground_truth: Union[str, List[str]], enable_llm=False
):
